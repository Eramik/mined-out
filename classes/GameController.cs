...
namespace Mined_Out {
    ...
    public class GameController {
        ...
        private void Walking() {
            ...
            while(true) {
                ...
                if(key == ConsoleKey.DownArrow ||
                    ...
                    string path = Prompt("Please, enter a name of a file to load:");
                    field.SaveToFile("E:\\" + path + ".json");
                    field.PrintToConsole();
                    continue;
                    ...
                    try
                    {
                        field.LoadFromFile("E:\\" + path + ".json");
                    } catch(Exception e)
                    {
                        NotifyUser("Save file with the name not found");
                    }
                    field.PrintToConsole();
                    continue;
                } else {
        ...
        private void Help() {
            ...
            Press U when in game to save level to file
            Press I when in game to load level from file
